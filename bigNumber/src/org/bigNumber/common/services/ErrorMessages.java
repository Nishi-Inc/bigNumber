...
public enum ErrorMessages {
    INCOMPATIBLE_VALUE_MSG("Value is incompatible."), TWO_DECIMAL_POINTS_MSG("A number cannot have two decimal points."), NEW_DIGIT_INCOMPATIBLE_MSG("newDigit is incompatible."), SECOND_NUMBER_NEGATIVE_MSG("Second number should not be negative.");
